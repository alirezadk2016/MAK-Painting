    ...
    <div className="fixed bottom-0 inset-x-0 z-40 lg:hidden bg-white border-t border-gray-100 shadow-[0_-4px_24px_rgba(0,0,0,0.1)] px-4 py-3 safe-area-inset-bottom">
      <div className="flex gap-3">
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 border-2 border-blue-brand text-blue-brand font-bold rounded-xl py-3 text-sm"
        >
        ...
        <button
          onClick={open}
          className="flex-[2] bg-terra text-white font-bold rounded-xl py-3 text-sm shadow-md"
        >
          Get free quote
        </button>
      </div>
